      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            {/* Header row */}
            <div className="grid grid-cols-8 gap-2 text-caption font-medium text-text-tertiary px-2">
            ...
            {metrics.byCategory.map((cat) => {
              ...
              return (
                <div key={cat.category} className="grid grid-cols-8 gap-2 items-center rounded-md px-2 py-2 transition-colors hover:bg-surface-tertiary">
